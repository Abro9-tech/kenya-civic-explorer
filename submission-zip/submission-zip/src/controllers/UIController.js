...
import { sanitizeHTML, escapeHTML } from '../utils/helpers.js';
...
export class UIController {
    ...
    createResultCard(item) {
        ...
        const code = escapeHTML(item.code || 'N/A');
        const type = escapeHTML(item.type);
        const county = item.county ? escapeHTML(item.county) : '';
        const constituency = item.constituency ? escapeHTML(item.constituency) : '';
